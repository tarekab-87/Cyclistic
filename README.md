...
4. Outlier Removal: Used interquartile range (IQR) to filter out anomalous ride lengths.
5. Final Dataset: Excluded rows with null values and retained clean, consistent data for analysis.

### 4. Analysis and Insights

1. Usage Patterns

![Rides by Day of Week](charts/rides_by_day.png)
...
![Rides by Rideable Type](charts/rides_by_rideable_type.png)
...
![Average Ride Length by Rideable Type](charts/avg_ride_length_by_type.png)
...
![Average Rides per Weekday - Casual](charts/rides_by_day.png)
...
![Average Rides per Weekday - Member vs Casual](charts/rides_by_day.png)
...
![Average Rides per Month - Casual](charts/avg_rides_per_month.png)
...
![Average Rides per Month - Member](charts/avg_rides_per_month.png)
...
![Average Rides by Hour and Day](charts/avg_rides_by_hour_and_day.png)
...
![Top Routes](charts/top_routes.png)
...
![Top Routes for Members](charts/top_routes_member.png)
